package com.coll.OnlineCollaborateBackEnd.services;
...
public class EmailService {
	...
	private static String from = "eLearnz";
	...
	public void approvedUserMessage(User user){
		...
		try {
			...
			htmlMsg.append("<h1>Welcome " + user.getFullname() + "!</h1>");
		    ...
		    helper.setSubject("Welcome to eLearnz");
		    helper.setFrom(from);
